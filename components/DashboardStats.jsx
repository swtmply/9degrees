...
export default function DashboardStats({ all, mine, session}) {
    ...
    <div>
      <div className="flex items-center grid grid-cols-6">
        <div>
          ...
          <div className="stats font-mono">
              {session?.user.role == "Writer"
              ? (mineForApproval ? mineForApproval : 0)
